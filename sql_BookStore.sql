...
select b.title,sum(oi.quantity) as totalQuantity from books as b join order_items as oi where 
b.book_id=oi.book_id group by b.title order by totalQuantity desc limit 1;